...
int main()
{
    ...
    device->getFileSystem()->addFileArchive(getMediaPath("map-20kdm2.pk3"));
    ...
    */
    ...
    bill->setMaterialTexture(0, driver->getTexture(getMediaPath("particle.bmp")));
    ...
    node = smgr->addAnimatedMeshSceneNode(smgr->getMesh(getMediaPath("faerie.md2")),
                                          0, IDFlag_IsPickable | IDFlag_IsHighlightable);
    node->setPosition(core::vector3df(-90,-15,-140)); // Put its feet on the floor.
    node->setScale(core::vector3df(1.6f)); // Make it appear realistically scaled
    node->setMD2Animation(scene::EMAT_POINT);
    node->setAnimationSpeed(20.f);
    material.setTexture(0, driver->getTexture(getMediaPath("faerie2.bmp")));
    ...
    node = smgr->addAnimatedMeshSceneNode(smgr->getMesh(getMediaPath("ninja.b3d")),
                                          0, IDFlag_IsPickable | IDFlag_IsHighlightable);
    ...
    node = smgr->addAnimatedMeshSceneNode(smgr->getMesh(getMediaPath("dwarf.x")),
                                          0, IDFlag_IsPickable | IDFlag_IsHighlightable);
    ...
    node = smgr->addAnimatedMeshSceneNode(smgr->getMesh(getMediaPath("yodan.mdl")),
                                          0, IDFlag_IsPickable | IDFlag_IsHighlightable);
